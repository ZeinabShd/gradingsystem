...
<?php $component->withAttributes([]); ?>
    ...
    <div class="p-6">
        <table class="min-w-full border text-sm">
            <a href="<?php echo e(route('enrollments.create')); ?>" class="inline-block mb-4 bg-blue-600 text-white px-3 py-2 rounded">New Enrollment</a>
            <td class="p-2 border">
...
<?php endif; ?>
<?php /**PATH C:\Users\Zeinab\Desktop\grading\resources\views/enrollments/index.blade.php ENDPATH**/ ?>